...
PLATZHALTER_KATALOG = [
    ...
    {"key": "ANREDE", "beschreibung": "Anrede der Mandantschaft (Herr/Frau)", "beispiel": "Herr"},
    {"key": "ANREDE_DEKL", "beschreibung": "Anrede gebeugt (Herrn/Frau)", "beispiel": "Herrn"},
    {"key": "PRON", "beschreibung": "Pronomen: er/sie", "beispiel": "er"},
    {"key": "PRON_DAT", "beschreibung": "Pronomen Dativ: ihm/ihr", "beispiel": "ihm"},
    {"key": "PRON_AKK", "beschreibung": "Pronomen Akkusativ: ihn/sie", "beispiel": "ihn"},
    {"key": "POSS", "beschreibung": "Possessiv: sein/ihr", "beispiel": "sein"},
    {"key": "POSS_E", "beschreibung": "Possessiv: seine/ihre", "beispiel": "seine"},
    {"key": "POSS_EM", "beschreibung": "Possessiv Dativ: seinem/ihrem", "beispiel": "seinem"},
    {"key": "POSS_EN", "beschreibung": "Possessiv: seinen/ihren", "beispiel": "seinen"},
    {"key": "POSS_ER", "beschreibung": "Possessiv: seiner/ihrer", "beispiel": "seiner"},
    {"key": "POSS_ES", "beschreibung": "Possessiv Genitiv: seines/ihres", "beispiel": "seines"},
    {"key": "PRON_GROSS", "beschreibung": "Pronomen am Satzanfang: Er/Sie", "beispiel": "Er"},
    {"key": "MANDANT_NOM", "beschreibung": "Mandant/Mandantin (Nominativ)", "beispiel": "Mandant"},
    {"key": "MANDANT_OBL", "beschreibung": "Mandanten/Mandantin (gebeugt)", "beispiel": "Mandanten"},
    {"key": "UNSER", "beschreibung": "unser/unsere", "beispiel": "unser"},
    {"key": "UNSER_GROSS", "beschreibung": "Unser/Unsere (Satzanfang)", "beispiel": "Unser"},
    {"key": "UNSERES", "beschreibung": "unseres/unserer (Genitiv)", "beispiel": "unseres"},
    {"key": "UNSEREM", "beschreibung": "unserem/unserer (Dativ)", "beispiel": "unserem"},
]
