...
class TestPolicyFuerDomain(unittest.TestCase):
    def test_placetel_ist_nur_anhaenge(self):
        self.assertEqual(rausch_regel.policy_fuer_domain("placetel.de"), "nur_anhaenge")
...
class TestLadeRegeln(unittest.TestCase):
    def test_gueltige_yaml(self):
        ...
        self.assertEqual(regeln, {"a.de": "nur_anhaenge", "b.de": "komplett"})
    ...
    def test_standard_registry_laedt(self):
        ...
        self.assertEqual(regeln.get("placetel.de"), "nur_anhaenge")
