...
function SchadenSection({ schaden, hq, dispatch, akteId, vorsteuer = false, dokumente, belegeKandidaten = [] }) {
  ...
  const renderEuroInput = (fieldKey, { abzug=false, extraValue, onExtraChange } = {}) => {
    ...
    return (
      <div style={{ display:"flex", border:`1.5px solid ${isFoc ? T.gold : isWbwAusreichend ? T.green+"66" : T.border}`, borderRadius:5, overflow:"hidden", background:isWbwAusreichend ? T.green+"10" : T.surface, maxWidth:240, transition:"border-color 0.15s" }}>
        <span style={{ padding:"4px 7px", fontFamily:"'IBM Plex Mono',monospace", fontSize:"0.82rem", color:abzug?T.red:isWbwAusreichend?T.green:T.textFaint, background:T.offWhite, borderRight:`1px solid ${T.border}`, flexShrink:0 }}>{abzug?"−€":"€"}</span>
        <input
          type="text"
          inputMode="decimal"
          ...
          placeholder="0,00"
          style={{ flex:1, minWidth:0, padding:"4px 8px 4px 6px", border:"none", background:"transparent", outline:"none", fontFamily:"'IBM Plex Mono',monospace", fontSize:"0.82rem", color:isWbwAusreichend?T.green:T.text, textAlign:"right", fontWeight:isWbwAusreichend?600:400 }}
        />
      </div>
    );
  };
            ...
            <div style={{ flex:1, display:"flex", overflow:"hidden" }}>
              ...
              <div style={{ width:270, flexShrink:0, padding:"1.25rem 1.5rem", borderRight:`1px solid ${T.border}`, display:"flex", flexDirection:"column", gap:16, overflowY:"auto" }}>
                <div>
                  ...
                  <div style={{ fontSize:"1.6rem", fontWeight:700, color:T.navy, fontFamily:"'IBM Plex Mono',monospace" }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize:"1.15rem", fontWeight:700, fontFamily:"'IBM Plex Mono',monospace",
              ...
              <div style={{ flex:1, position:"relative" }}>
                {kandidatVorschauLaden ? (
                  ...
                  <div style={{ display:"flex", alignItems:"center", justifyContent:"center", height:"100%", color:T.textFaint, fontFamily:"'IBM Plex Sans',sans-serif", fontSize:"0.9rem" }}>
        ...
        <div style={{ padding:"0.5rem 1.4rem 1.25rem" }}>
          ...
          {gutachtenDoks.length > 0 && !showGutImport && (
            <div style={{ marginBottom:"1rem", padding:"10px 14px", background:T.greenBg, border:`1px solid ${T.green}33`, borderRadius:8, display:"flex", alignItems:"center", gap:10 }}>
              ...
              <div style={{ flex:1, minWidth:0 }}>
                <div style={{ fontFamily:"'IBM Plex Sans',sans-serif", fontSize:"0.875rem", fontWeight:600, color:T.green }}>
                  {gutachtenDoks.length === 1 ? "Gutachten erfasst" : `${gutachtenDoks.length} Gutachten erfasst`}
                </div>
                <div style={{ fontFamily:"'IBM Plex Sans',sans-serif", fontSize:"0.82rem", color:T.textMuted, overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap" }}>
                    ...
                    {beleg ? (
                      <>
                        {beleg.betrag_aus_beleg > 0 && beleg.betrag_aus_beleg !== (form[f.k]||0) && (
                          <button onClick={() => { setForm(p => ({...p, [f.k]: beleg.betrag_aus_beleg})); setChg(true); setToast(`${fmtEuro(beleg.betrag_aus_beleg)} übernommen.`); }}
                            ...
                            style={{ fontFamily:"'IBM Plex Sans',sans-serif", fontSize:"0.72rem", fontWeight:600,
                        ...
                        <button onClick={() => setBelegVorschau(beleg.dokument_id)}
                          ...
                          <span style={{ fontFamily:"'IBM Plex Sans',sans-serif", fontSize:"0.75rem", color:T.blue,
                      ...
                      <div style={{ position:"relative" }}>
                        <button onClick={() => setBelegZuordnen(istZuordnen ? null : f.k)}
                          ...
                          style={{ fontFamily:"'IBM Plex Sans',sans-serif", fontSize:"0.72rem",
                          ...
                          <>
                            ...
                            <div style={{ position:"absolute", top:"calc(100% + 4px)", right:0, zIndex:801,
                              ...
                              {belegfaehigePdfs.length > 0 ? belegfaehigePdfs.map(d => (
                                ...
                                <div style={{ padding:"14px 16px", color:T.textFaint, fontFamily:"'IBM Plex Sans',sans-serif", fontSize:"0.84rem", textAlign:"center" }}>
                ...
                {referenzKandidaten.map((k, i) => {
                  ...
                  return (
                    <div key={i} style={{ display:"flex", alignItems:"center", gap:8, padding:"3px 0", borderTop: i>0 ? `1px solid ${T.borderSoft}` : "none" }}>
                      <span style={{ fontFamily:"'IBM Plex Sans',sans-serif", fontSize:"0.82rem", color:T.text, flex:1, overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap" }}>
                  ...
                  <tbody>
                    {extras.map((e, i) => (
                      <tr key={e.id} style={{ borderBottom:`1px solid ${T.border}` }}>
                        ...
                        <td style={{ padding:"8px 12px", textAlign:"right", fontFamily:"'IBM Plex Mono',monospace", fontWeight:600, color:T.navy }}>
                    ...
                    {showAdd && (
                      <tr style={{ background:T.goldPale }}>
                        ...
                        <td style={{ padding:"8px 12px", textAlign:"right", fontFamily:"'IBM Plex Mono',monospace", fontSize:"0.875rem", color:T.textMuted }}>
          ...
          <div style={{ borderTop:`2px solid ${T.border}`, paddingTop:"1rem", marginTop:"1.25rem", display:"grid", gridTemplateColumns:"1fr 1fr 1fr", gap:"1rem" }}>
            {[
              ...
              <div key={i} style={{ background:s.bg, borderRadius:10, padding:"0.85rem 1rem", border:`1px solid ${T.border}` }}>
                ...
                {i < 2 ? (
                  <div style={{ fontFamily:"'Plus Jakarta Sans',sans-serif", fontSize:"1.625rem", fontWeight:700, color:s.c }}>{s.v}</div>
                ) : (
