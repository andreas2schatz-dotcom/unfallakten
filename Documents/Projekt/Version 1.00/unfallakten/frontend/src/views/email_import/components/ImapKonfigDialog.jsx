      ...
      <div style={{ background:T.cardBg, borderRadius:12, width:"100%", maxWidth:520, boxShadow:"0 8px 40px rgba(0,0,0,0.18)", overflow:"hidden" }}>
        <div style={{ background:T.navy, padding:"1rem 1.4rem", display:"flex", justifyContent:"space-between", alignItems:"center" }}>
          <div>
            ...
            <div style={{ fontFamily:T.fontBody, fontSize:"0.8rem", color:"rgba(255,255,255,0.5)", marginTop:2 }}>
        ...
        <div style={{ padding:"1.2rem 1.4rem", display:"flex", flexDirection:"column", gap:"0.85rem" }}>
          <div style={{ background:T.amberBg, border:`1px solid ${T.amber}44`, borderRadius:7, padding:"8px 12px", fontSize:"0.825rem", color:T.amber, fontFamily:T.fontBody }}>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"1fr auto", gap:"0.75rem", alignItems:"start" }}>
            <div>
              <label style={{ fontFamily:T.fontBody, fontSize:"0.83rem", fontWeight:600, color:T.textMid, display:"block", marginBottom:4 }}>
          ...
          {testMsg && (
            <div style={{ padding:"7px 12px", borderRadius:6, fontSize:"0.83rem", fontFamily:T.fontBody,
