    ...
    return (
      <div style={{ display:"flex", flexDirection:"column", gap:6 }}>
        <div style={{ display:"flex", alignItems:"center", gap:7,
          ...
          borderRadius:7, padding:"8px 12px", fontFamily:T.fontBody,
      ...
      <div style={{ display:"flex", flexDirection:"column", gap:6 }}>
        <div style={{ display:"flex", alignItems:"center", gap:7,
          ...
          <button onClick={() => setBestaetigen(true)} disabled={laedt}
            style={{ background:"none", border:`1px solid ${T.green}55`, borderRadius:5,
              padding:"2px 9px", fontFamily:T.fontBody, fontSize:"0.8rem",
        ...
        {bestaetigen && (
          <div style={{ background:T.amberBg, border:`1px solid ${T.amber}44`,
            borderRadius:7, padding:"10px 12px", fontFamily:T.fontBody,
            ...
            <div style={{ display:"flex", gap:8 }}>
              ...
              <button onClick={() => setBestaetigen(false)}
                style={{ padding:"5px 12px", background:"none", color:T.textMuted,
                  ...
                  fontFamily:T.fontBody, fontSize:"0.855rem", cursor:"pointer" }}>
                Abbrechen
              </button>
            </div>
          </div>
        ...
        {fehler && (
          <div style={{ fontSize:"0.845rem", color:T.red, fontFamily:T.fontBody }}>{fehler}</div>
        )}
      </div>
    );
  }
