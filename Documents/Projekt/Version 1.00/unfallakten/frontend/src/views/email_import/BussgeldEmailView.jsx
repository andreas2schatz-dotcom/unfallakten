...
export default function BussgeldEmailView() {
  return (
    <div style={{
      background: T.white,
      ...
      <p style={{
        ...
        Eingehende Bußgeldbescheide und Anfragen an{" "}
        <span style={{ fontFamily: "'IBM Plex Mono',monospace", color: T.navy }}>
          bussgeld@anwalt-offenbach.de
        </span>{" "}
        werden hier bearbeitet, sobald das Modul implementiert ist.
      </p>
      <div style={{
        ...
        {[
          "Fristberechnung (Einspruch: 2 Wochen ab Zustellung)",
          "Mandant-Zuordnung und Vorgangs-Erstellung",
          "Automatische Aktenanlage für Bußgeldmandate",
          "Frist-Erinnerungen und Wiedervorlage",
        ].map((f, i) => (
          <div key={i} style={{
