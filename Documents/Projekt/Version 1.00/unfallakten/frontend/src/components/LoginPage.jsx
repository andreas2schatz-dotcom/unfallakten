...
function LoginPage({ onLogin }) {
  ...
  const inp = {
    ...
    borderRadius:8, fontSize:"1.045rem", fontFamily:T.fontBody,
    color:T.text, background:T.surface, outline:"none", boxSizing:"border-box",
  };

  return (
    <div style={{ minHeight:"100vh", display:"flex", alignItems:"center", justifyContent:"center",
      background:T.cardBg, position:"relative", overflow:"hidden" }}>
      ...
      <div style={{ position:"relative", width:"100%", maxWidth:440, padding:"1.5rem",
        ...
        {/* Card */}
        <div style={{ background:T.cardBg, borderRadius:16, padding:"2.4rem 2.6rem",
          boxShadow:"0 4px 32px rgba(0,0,0,0.08), 0 0 0 1.5px rgba(15,30,64,0.10)" }}>
          <div style={{ fontFamily:T.fontBody, fontSize:"1.1rem",
