    ...
    >
      ...
      <div style={{
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "1.25rem 1.4rem", display: "flex", flexDirection: "column", gap: "1rem" }}>
          ...
          {loading && (
            <div style={{ textAlign: "center", padding: "2rem", color: T.textMuted, fontFamily: T.fontBody }}>
              Analysiere Akte…
            </div>
          )}
            ...
            <>
              ...
              <div style={{
                ...
                {kontext.letztes_schreiben ? (
                  <>
                    <div style={{ fontFamily: T.fontBody, fontSize: "0.875rem", color: T.white, fontWeight: 600 }}>
                      Letztes Schreiben: {kontext.letztes_schreiben.typ_label} v. {kontext.letztes_schreiben.datum_fmt}
                    </div>
                    <div style={{ fontFamily: T.fontBody, fontSize: "0.82rem", color: "rgba(255,255,255,0.5)", marginTop: 3 }}>
                  ...
                  <div style={{ fontFamily: T.fontBody, fontSize: "0.875rem", color: "rgba(255,255,255,0.6)" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                <span style={{ fontFamily: T.fontBody, fontSize: "0.875rem", fontWeight: 600, color: T.text }}>
                  Eskalationsstufe:
                </span>
                <button
                  ...
                  style={{
                    ...
                    fontFamily: T.fontBody, fontSize: "1.1rem", fontWeight: 700,
                    display: "flex", alignItems: "center", justifyContent: "center",
                  }}
                >−</button>
                <div style={{
                ...
                >+</button>
                {dirty && (
                  <span style={{ fontFamily: T.fontBody, fontSize: "0.78rem", color: T.amber }}>
                    * bearbeitet
                  </span>
                )}
              </div>
              ...
              {confirm && (
                <div style={{
                  ...
                  <span style={{ fontFamily: T.fontBody, fontSize: "0.875rem", color: T.text, flex: 1 }}>
                    Manuelle Änderungen verwerfen und Stufe {confirm.zielStufe} laden?
                  </span>
                  <div style={{ display: "flex", gap: 8 }}>
                    <button onClick={() => setConfirm(null)}
                      style={{ padding: "4px 12px", borderRadius: 6, border: `1px solid ${T.border}`, background: "none", cursor: "pointer", fontFamily: T.fontBody, fontSize: "0.845rem", color: T.text }}>
                      Nein
                    </button>
                    <button onClick={bestaetigenUeberschreiben}
                      style={{ padding: "4px 12px", borderRadius: 6, border: "none", background: T.amber, cursor: "pointer", fontFamily: T.fontBody, fontSize: "0.845rem", fontWeight: 600, color: "#fff" }}>
                      Ja, verwerfen
                    </button>
                  </div>
                </div>
