...
**Commits:** `a209c74f` (Backend W-1/W-2/W-3), `585b38c4` (Frontend W-1/W-4), `274fc824` (Doku), `3336b50c` (W-4-Nachbesserung Aktualisieren-Pfad), `514a3ae8` (Schutzplanke `kalender_zu_kuerzel()` + DECISIONS-Korrektur), `daa0ed01` (Doku), `fcfb23ae` (Mount-Pfad-Nachbesserung), `4d786ac8` (Doku), `ba19d15a` (Leer-Antwort-Guard), plus der zugehörige Doku-Commit dieses Abschnitts. Backend-Vollsuite **1773 passed / 20 skipped / 0 failed** (440.00 s), Frontend **539/539** (87 Testdateien).
