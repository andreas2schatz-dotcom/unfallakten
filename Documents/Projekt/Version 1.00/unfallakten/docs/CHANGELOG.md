...
- `b4d7f289` Fix: „für Sie kostenfrei"-Aussage nur noch bei Vollhaftung (Spec §15; Fund des Whole-Branch-Final-Reviews) — `getragen_von = "gegner"` nur wenn keine Abrechnung `haftungsquote < 100`; sonst neutraler „Kostentragung … gesondert"-Satz im Schreiben. +2 Tests.
