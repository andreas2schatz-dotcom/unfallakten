...
4. **PRD-38 — Dokumentenbezeichnung per LLM vorschlagen** (neu, 2026-07-15, Nutzerwunsch): Die Dokumentenbezeichnung (Feld aus PRD-37) zusätzlich/alternativ **per LLM** aus dem Dokumentinhalt vorschlagen. Baut auf PRD-37 auf. Noch nicht gebrainstormt.
