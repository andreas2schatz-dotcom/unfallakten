...
3. **PRD-37 — Dokumentenbezeichnung vorschlagen + Feld** (neu, 2026-07-15, Nutzerwunsch): Neues Feld „Dokumentenbezeichnung" (sprechender Titel/Bezeichnung eines Dokuments) im Review bzw. an der Dokument-Zeile; das System schlägt eine Bezeichnung vor (regelbasiert, z. B. aus Klasse/Absender/Datum/Betrag). Noch nicht gebrainstormt — Start: `superpowers:brainstorming` (Feld-Ort, Vorschlags-Quelle, editierbar, Persistenz).
