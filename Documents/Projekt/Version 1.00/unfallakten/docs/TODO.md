...
**Stand 2026-07-17 (abends):** Rausch-Absender-Aussortierung + Papierkorb (Punkt 1) **vollständig abgeschlossen inkl. DEV-Smoke** und in `main`. **Aktuelles Topic: PRD-33 Klage-Wizard** — Ist-Analyse abgeschlossen (40 Bugs → `docs/BUGFIX_KLAGE_WIZARD.md`), **Bugfix-Session 1 ✅** (KW-01+KW-23, KW-02, KW-14, in main `578c93e0`), **Bugfix-Session 2 ✅ umgesetzt 2026-07-17** (KW-03 Quote-Fälle A/B Backend+Frontend, KW-04 eine Rechenquelle + DOCX-Direkttest-Muster `test_klage_service_docx.py`, KW-05 Eigentum/§1006, KW-07 SG-Ausschluss, KW-11 Unkostenpauschale-Semantik, **KW-39 vorgezogen**; Branch `klage-wizard-fixes-s2`, je Task Review + Fix-Wave, Baseline Backend 204f/1000p null neue, Frontend 122 + Build; FF-Merge nach Freigabe ausstehend — Details/Commits im Tracking-Doc). Sessions 3–6 offen (nächste: S3 Rubrum/Grammatik-Cluster KW-06/15–21 als V3-Partei-Objekt). Bewusst vertagt: Prod-Rollout (Punkt 3), PRD-38 (Punkt 6), N-05 + P1.8 (siehe „Zurückgestellt" unten).
