...
**Aktueller Schritt:** **S1 komplett** (S1.1–S1.9) + **P1.1 – P1.7** ✅ (P1.7 am 2026-07-10). Nächster Schritt: **P1.8** (Backfill synthetischer Ereignisse aus Bestand + K-M3 Backfill-Ehrlichkeits-Hinweis im Dashboard). **Baseline für P1.8**: 212 failed / 677 passed / 18 skipped auf `intake-stufe1` (nach P1.7). Delta gegen P1.6-Baseline (209f/670p): +10 neue Backend-Tests (4 has_unbestaetigt/aggregation/label/kategorie + 6 Ereignisliste-Endpoint), +3 test-order failures rein in bekannten Alt-Kategorien. Zusätzlich Vitest + 26 grüne Frontend-Tests (4 Files: AbleitungBadge 6, PositionsDashboard 7, EreignislistePanel 7, DokumentAktionsmenue 6). Keine echte Regression.
