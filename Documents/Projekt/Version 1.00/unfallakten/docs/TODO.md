...
- **Nächste Session (Entscheidung RA Schatz, 2026-07-13): N-01 + N-06 zuerst** — die zwei Korrektheits-Retrofits (N-01 Textebenen-Qualitätscheck/Wörterbuch-Abgleich → Schrott-Text-Fallback auf OCR; N-06 Seitenauswahl für die Qwen-Extraktion statt erste 10.000 Zeichen). Definitionen: `FREIGABE-NACHTRAG-1.md` Abschnitt A. **Vor jedem Punkt prüfen, ob der bestehende Code das Verhalten schon teilweise abdeckt (v. a. N-01) — nur die Differenz bauen.** Golden-File-Tests grün halten, jeder Punkt einzeln testbar (TDD). **Danach zweite Welle:** N-02 (OCR-Qualitäts-Badge in Review-Queue), N-03 (Retry-Differenzierung), N-04 (Seiten-Triage/Fotoseiten überspringen), N-05 (kooperatives Yielding + Teilergebnisse) + Folge-Task **Fragebogen-Feld-Übernahme bei Freigabe** (aus BUG-01, direkter Alltagsnutzen). In frischer Session fortsetzen.
