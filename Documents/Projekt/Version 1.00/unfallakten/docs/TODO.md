...
- **Code-Review Intake-Pipeline v7 (2026-07-12): 30 Bugs** — Multi-Agent-Review des Branches `intake-stufe1` (39 verifizierte Funde, dedupliziert). Tracking mit Checkboxen, Prioritäten P0–P4 und Session-Aufteilung: **`docs/BUGFIX_INTAKE_V7.md`**.
  ...
  - **Offen: P2 (BUG-08–13)** = nächste Session: RA-MICRO-only-Akten-404 (BUG-08), SQLite-Selbstblockade Fristablauf (BUG-09), Gunicorn-4×-Scheduler (BUG-10), Upload-Validierung (BUG-11), O(n²)-OCR (BUG-12), Migration-50-executescript (BUG-13). Danach P3, P4.
