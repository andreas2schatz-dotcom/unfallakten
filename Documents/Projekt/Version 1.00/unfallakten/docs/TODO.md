...
- **N-02 ✅ ERLEDIGT (2026-07-13, TDD)** — Branch `intake-stufe1`, noch nicht committet. OCR-Qualitätsmetriken persistieren + Badge in der Review-Queue (`FREIGABE-NACHTRAG-1.md` Abschnitt A).
...
- **Nächste Session (Rest zweite Welle):** N-03 (Retry-Differenzierung: Timeout/Ressourcendruck/Modellfehler), N-04 (Seiten-Triage/Fotoseiten vor GLM überspringen), N-05 (kooperatives Yielding + Teilergebnisse) + Folge-Task **Fragebogen-Feld-Übernahme bei Freigabe** (aus BUG-01, direkter Alltagsnutzen). Definitionen: `FREIGABE-NACHTRAG-1.md` Abschnitt A. In frischer Session fortsetzen.
