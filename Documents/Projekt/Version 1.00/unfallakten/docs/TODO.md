...
Nächster Schritt gemäß freigabe.md Abschnitt 4: **P1.3** (Ableitung: `positionsstatus_service` + `/positionen/status`-Endpoint + `/aktionen`-Matrix). Danach P1.4 (ausgehende Ereignisse), dann P1.5 (eingehende Ereignisse).
