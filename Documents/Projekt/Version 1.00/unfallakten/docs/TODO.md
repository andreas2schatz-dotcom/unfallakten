...
**Stand 2026-07-17:** Rausch-Absender-Aussortierung + Papierkorb (Punkt 1) **vollständig abgeschlossen inkl. DEV-Smoke** und in `main`. **Aktuell kein Feature in Arbeit — nächstes Topic offen** (vom Nutzer zu setzen). Bewusst vertagt: Prod-Rollout (Punkt 3), PRD-38 (Punkt 6), N-05 + P1.8 (siehe „Zurückgestellt" unten).
