...
### Mittel
- **Intake-Klassifikation/Extraktion — Restpunkte aus Befund 1280/25 (2026-08-06):** (a) Marker „Rechnung" trifft als Teilwort auch „**Ab**rechnung" → Wortgrenzen-Matching (\b, vgl. Gutachten-Parser-Lektion), Auto-Vorschlag stufte VHV-Abrechnungsschreiben als `rechnung` ein; (b) Schadennummer-Regex `[A-Z0-9\-/]+` bricht an Leerzeichen ab („SD0" statt „SD0 0003 2129 28 T01"); (c) LLM/Regex-Konsens-Check meldet Datums-Scheinkonflikt (ISO vs. deutsch) → vor Vergleich normalisieren. Kontext: CHANGELOG 2026-08-06.
