...
- **Nächste Session (Rest zweite Welle):** **N-05-Entscheidung** (kooperatives Yielding + Teilergebnisse — bewusst vertagt, jetzt anhand echter Durchsatz-Zahlen neu bewerten; zerfällt in Teil A „Teilergebnisse-bei-Fehler" + Teil B „Yielding/Pause-Resume") + Folge-Task **Fragebogen-Feld-Übernahme bei Freigabe** (aus BUG-01, direkter Alltagsnutzen). Danach **Rollout-Entscheidung** für `intake-stufe1` (viele Commits vor `main`). Definitionen: `FREIGABE-NACHTRAG-1.md` Abschnitt A.
