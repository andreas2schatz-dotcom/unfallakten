...
**Offen:** Browser-Abnahme Popup RA Schatz (jetzt direkt an 1280/25 möglich). Zurückgestellte Minors (Reparse-Hinweis bei geprüftem Ergebnis, Clipboard-Feedback, Dialog-A11y, 600-Zeichen-Fallback-Test, `VHV_TELEFON_MUSTER`-IGNORECASE) → bei nächster Anfassung der Dateien.
